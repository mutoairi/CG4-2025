...
/// モデル共通データ
/// </summary>
class ModelCommonProject {
public:
	static ModelCommonProject* GetInstance();
...
private:
	ModelCommonProject() = default;
	~ModelCommonProject() = default;
	ModelCommonProject(ModelCommonProject&) = delete;
	ModelCommonProject& operator=(ModelCommonProject&) = delete;
	...
	// シングルトンインスタンス
	static ModelCommonProject* sInstance_;
...
public: // 静的メンバ関数
	...
	static ModelProject* CreateFromOBJ(const std::string& modelname, bool smoothing = false);
